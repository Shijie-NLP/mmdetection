...
class DetInferencer(BaseInferencer):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        for ori_imgs, data in track(inputs, description="Inference") if self.show_progress else inputs:
    ...
    def visualize(
        ...
        **kwargs,
        ...
        if self.visualizer is None:
            raise ValueError('Visualization needs the "visualizer" termdefined in the config, but got None.')
