...
from mmdet.datasets.transforms import LoadAnnotations, PackDetInputs, RandomCrop, RandomFlip, Resize
...
from mmdet.models.task_modules import BBoxL1Cost, FocalLossCost, HungarianAssigner, IoUCost
...
backend_args = backend_args  # noqa: F405
...
train_dataloader.update(dict(dataset=dict(filter_cfg=dict(filter_empty_gt=False), pipeline=train_pipeline)))
