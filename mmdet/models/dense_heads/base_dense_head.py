...
class BaseDenseHead(BaseModule, metaclass=ABCMeta):
    ...
    def get_positive_infos(self) -> Optional[InstanceList]:
    ...
    def aug_test(self, aug_batch_feats, aug_batch_img_metas, rescale=False, with_ori_nms=False, **kwargs):
        ...
        for x, img_metas in zip(aug_batch_feats, aug_batch_img_metas):
            ...
            batch_instance_results = self.get_results(
                *outs, img_metas=img_metas, cfg=self.test_cfg, rescale=False, with_nms=with_ori_nms, **kwargs
            )
        ...
        for img_id in range(num_imgs):
            ...
            if rescale:
                ...
                scale_factor = results.bboxes.new_tensor(aug_batch_img_metas[0][img_id]["scale_factor"])
