...
from mmdet.structures.bbox import cat_boxes, empty_box_as, get_box_tensor, get_box_wh, scale_boxes
...
class RPNHead(AnchorHead):
    ...
    def __init__(
        ...
        in_channels: int,
        num_classes: int = 1,
        init_cfg: MultiConfig = dict(type="Normal", layer="Conv2d", std=0.01),  # noqa
        num_convs: int = 1,
        **kwargs,
    ) -> None:
