...
class DINO(DeformableDETR):
    ...
    def _init_layers(self) -> None:
        ...
        self.embed_dims: int = self.encoder.embed_dims
    ...
    def pre_decoder(
        ...
        # encoder queries.
        if self.training:
            head_inputs_dict = dict(enc_outputs_class=topk_score, enc_outputs_coord=topk_coords, dn_meta=dn_meta)
        else:
    ...
    def forward_decoder(
        ...
        **kwargs,
        ...
        if len(query) == self.num_queries:
            # NOTE: This is to make sure label_embedding can be involved to
