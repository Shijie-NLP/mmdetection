...
class ResLayer(Sequential):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        downsample = None
        conv_norm_cfg = dict(conv_cfg=conv_cfg, norm_cfg=norm_cfg)
        ...
        if downsample_first:
            ...
            for _ in range(1, num_blocks):
                layers.append(block(inplanes=inplanes, planes=planes, stride=1, **conv_norm_cfg, **kwargs))

        else:  # downsample_first=False is for HourglassModule
            for _ in range(num_blocks - 1):
                layers.append(block(inplanes=inplanes, planes=inplanes, stride=1, **conv_norm_cfg, **kwargs))
