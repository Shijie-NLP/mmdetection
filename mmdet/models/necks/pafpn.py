...
class PAFPN(FPN):
    ...
    def __init__(
        ...
        norm_cfg=None,
        act_cfg=None,
        init_cfg=dict(type="Xavier", layer="Conv2d", distribution="uniform"),  # noqa
    ):
        super().__init__(
            in_channels,
            out_channels,
        ...
        for i in range(self.start_level + 1, self.backbone_end_level):
            d_conv = ConvModule(out_channels, out_channels, 3, stride=2, padding=1, inplace=False, **conv_norm_act_cfg)
            pafpn_conv = ConvModule(out_channels, out_channels, 3, padding=1, inplace=False, **conv_norm_act_cfg)
