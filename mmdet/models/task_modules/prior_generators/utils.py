...
def anchor_inside_flags(
    flat_anchors: Tensor, valid_flags: Tensor, img_shape: tuple[int], allowed_border: int = 0
) -> Tensor:
...
def calc_region(bbox: Tensor, ratio: float, featmap_size: Optional[tuple] = None) -> tuple[int]:
